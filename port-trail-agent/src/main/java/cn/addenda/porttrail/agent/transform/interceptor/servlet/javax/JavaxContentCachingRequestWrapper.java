...
public class JavaxContentCachingRequestWrapper extends HttpServletRequestWrapper {
   ...
   */
  public JavaxContentCachingRequestWrapper(HttpServletRequest request) {
    super(request);
   ...
   * @since 4.3.6
   */
  public JavaxContentCachingRequestWrapper(HttpServletRequest request, int contentCacheLimit) {
    super(request);
