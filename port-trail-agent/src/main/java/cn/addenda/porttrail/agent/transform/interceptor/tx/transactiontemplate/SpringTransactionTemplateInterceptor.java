...
public class SpringTransactionTemplateInterceptor extends AbstractTxEntryPointInterceptor implements Interceptor {
  ...
  private static final PortTrailLogger log =
          AgentPortTrailLoggerFactory.getInstance().getPortTrailLogger(SpringTransactionTemplateInterceptor.class);
  ...
  protected EntryPoint entryPoint(String detail) {
    return EntryPoint.of(EntryPointType.TX_TRANSACTION_TEMPLATE, detail);
  }
