...
/**
 * 分析-SQL的explain(AnalyzeExplainResultEntity)实体类
 *
 * @author addenda
...
@Getter
@ToString
public class AnalyzeExplainResultEntity extends SimpleBaseModel implements Serializable {
  ...
  public static AnalyzeExplainResultEntity ofParam() {
    return new AnalyzeExplainResultEntity();
  }
