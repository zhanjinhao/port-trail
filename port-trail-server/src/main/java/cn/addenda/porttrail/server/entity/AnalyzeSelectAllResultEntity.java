...
/**
 * 分析-select语句是否有*(AnalyzeSelectAllResultEntity)实体类
 *
 * @author addenda
...
@Getter
@ToString
public class AnalyzeSelectAllResultEntity extends SimpleBaseModel implements Serializable {
  ...
  public static AnalyzeSelectAllResultEntity ofParam() {
    return new AnalyzeSelectAllResultEntity();
  }
