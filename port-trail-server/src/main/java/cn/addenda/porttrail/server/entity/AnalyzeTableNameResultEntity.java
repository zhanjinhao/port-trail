...
/**
 * 分析-表名(AnalyzeTableNameResultEntity)实体类
 *
 * @author addenda
...
@Getter
@ToString
public class AnalyzeTableNameResultEntity extends SimpleBaseModel implements Serializable {
  ...
  public static AnalyzeTableNameResultEntity ofParam() {
    return new AnalyzeTableNameResultEntity();
  }
