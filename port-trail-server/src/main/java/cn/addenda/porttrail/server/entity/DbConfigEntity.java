...
@Getter
@ToString
public class DbConfigEntity extends SimpleBaseModel implements Serializable {
  ...
  public static DbConfigEntity ofParam() {
    return new DbConfigEntity();
  }
