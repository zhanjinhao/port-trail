...
/**
 * StatementExecution(EstStatementExecution)实体类
 *
 * @author addenda
...
@Getter
@ToString
public class EstStatementExecution extends SimpleBaseModel implements Serializable {
  ...
  public static EstStatementExecution ofParam() {
    return new EstStatementExecution();
  }
