...
/**
 * PreparedStatementExecution(PreparedStatementExecutionEntity)实体类
 *
 * @author addenda
...
@Getter
@ToString
public class PreparedStatementExecutionEntity extends SimpleBaseModel implements Serializable {
  ...
  public static PreparedStatementExecutionEntity ofParam() {
    return new PreparedStatementExecutionEntity();
  }
