package cn.addenda.porttrail.server.sql;
...
public class MyTablesNamesFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor,
  ...
  public static Set<String> findTables(String sqlStr) throws JSQLParserException {
    MyTablesNamesFinder myTablesNamesFinder = new MyTablesNamesFinder();
    return myTablesNamesFinder.getTables(CCJSqlParserUtil.parse(sqlStr));
  }
  ...
  public static Set<String> findTablesInExpression(String exprStr) throws JSQLParserException {
    MyTablesNamesFinder myTablesNamesFinder = new MyTablesNamesFinder();
    return myTablesNamesFinder.getTables(CCJSqlParserUtil.parseExpression(exprStr));
  }
  ...
  public void visit(AnalyticExpression analytic) {
    ...
    if (analytic.getWindowElement() != null) {
      ...
      if (windowElement.getRange().getStart() != null
              && windowElement.getRange().getStart().getExpression() != null) {
        windowElement.getRange().getStart().getExpression().accept(this);
      }
      if (windowElement.getRange().getEnd() != null
              && windowElement.getRange().getEnd().getExpression() != null) {
        windowElement.getRange().getEnd().getExpression().accept(this);
      }
      if (windowElement.getOffset() != null
              && windowElement.getOffset().getExpression() != null) {
