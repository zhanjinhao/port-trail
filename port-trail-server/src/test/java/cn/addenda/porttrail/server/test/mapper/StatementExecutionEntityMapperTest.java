...
class StatementExecutionEntityMapperTest {
  ...
  void test() {
    ...
    transactionHelper.doTransaction(() -> {
      statementExecutionEntityMapper.insert(param);
    });


    Assertions.assertNotNull(statementExecutionEntityMapper.queryById(param.getId()));
    Assertions.assertNotNull(statementExecutionEntityMapper.deleteById(param.getId()));
    Assertions.assertNull(statementExecutionEntityMapper.queryById(param.getId()));
  }
